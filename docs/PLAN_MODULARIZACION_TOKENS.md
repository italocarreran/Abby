...
| 2. Lectura y utilidades comunes | **Implementada; pendiente revisión de Claude** | OOXML, normalización y filtros seguros sin copias |
| 3. Infraestructura de comparadores | **Implementada; pendiente revisión de Claude** | Estado, caché, cola UI y salida Excel sin mezclar sus motores |
